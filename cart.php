										...
										if(isset($_SESSION['cart'])){
											...
											<tr>
												...
												<td class="product-name"><a href="#"><?php echo $pname?></a>
													<ul  class="pro__prize">
														<li class="old__prize"><s>Rs.<?php echo $mrp?></s></li>
                                ...
                                <div class="col-md-12 col-sm-12 col-xs-12">
                                    <div class="buttons-cart--inner">
                                        <div class="buttons-cart">
                                            <a href="<?php echo SITE_PATH?>" style="background:hsl(19deg 90% 49%);,color:#f5f5f5">Continue Shopping</a>
                                        </div>
                                        <div class="buttons-cart checkout--btn">
                                           
                                            <a href="<?php echo SITE_PATH?>checkout.php"style="background:hsl(19deg 90% 49%);,color:#f5f5f5;">checkout</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
