                                ...
                                <div class="wishlist-table table-responsive">
                                    <table>
                                        ...
                                        <tbody>
                                            ...
                                            order_detail.*,product.name,product.image from order_detail,product
                                            , `order` where order_detail.order_id='$order_id' and `order`.user_id='$uid'
                                            and order_detail.product_id=product.id");
                                            $total_price=0;
                                            while($row=mysqli_fetch_assoc($res)){
                                                $total_price=$total_price+($row['qty']*$row['price'])+100;
                                            ...
                                            <tr>
                                                <td colspan="3"></td>
                                                <td class="product-name">Total Price  With Delivery Charge</td>
